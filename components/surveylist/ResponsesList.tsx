...
import type { FullResponse } from "@/lib/survey/data";
import { appUsageRoleLabels, label as labelFor } from "@/lib/survey-options";
import { ResponseDetail } from "@/components/surveylist/ResponseDetail";
          ...
          <summary className="flex cursor-pointer list-none flex-wrap items-center gap-3 px-4 py-3 [&::-webkit-details-marker]:hidden">
            ...
            {surveyorNames && (
              <span className="ml-auto text-xs text-muted-foreground">
                {(r.surveyor_id && surveyorNames[r.surveyor_id]) ?? "Unknown moderator"}
              </span>
            )}
          </summary>
